...
const TICKETS = [
  ...
  ...((() => {
    ...
    return [
      ...
      V('ALT-331','REAL editable grid (Excel view) — inline-edit cells, all modules','Feature','P1','In Progress',
      ...
      V('ALT-332','Multi-select (checkboxes) in Grid + Kanban — parity with Table','Feature','P1','In Progress',
      ...
      V('ALT-333','Standardize the list TOOLBAR across all modules (shared ListToolbar)','Chore','P1','In Progress',
      ...
      V('ALT-334','Preview "Open full record" opens in a NEW tab','Chore','P2','In Progress',
      ...
      V('ALT-335','Call-log (disposition + comment) section in the preview panel','Feature','P1','In Progress',
      ...
      V('ALT-336','Dashboard redesign per the Claude-design deck (dials + Scheduled/Successful funnel)','Feature','P1','Planned',
        'Ankit 2026-06-23: improve the dashboard to match the PDF deck made earlier with Claude-design (Ankit will re-share). Elements: DIALS gauges/dials, Meetings SCHEDULED, Meetings SUCCESSFUL — with the funnel rule that every Successful was once Scheduled (so it counts in Scheduled too) but not every Scheduled becomes Successful (some get dropped/cancelled/postponed). Manager/leadership decision charts driven by the call-log metrics (ALT-335). Ask Ankit to re-share the deck before building.'),
    ];
  })()),

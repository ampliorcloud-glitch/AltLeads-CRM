  ...
  ...((() => {
    ...
    return [
      ...
      V('ALT-375','Delight wave 2 — density / compact mode toggle (tables)','Feature','P2','In Progress',
        'UX-DELIGHT-BACKLOG Tier-1 (Cycle 9, QC PASS). New useDensity hook (mirrors useViewMode, per-user+entity localStorage) + DensityToggle segmented control; Comfortable (44px, pixel-identical to before — no regression) / Compact (32px, ~40% more rows). Wired into Leads table (reference) with a height transition; grid/kanban/data/sort/pagination untouched. Fan out to the other list pages next. Pure FE; vite green. Not pushed.'),

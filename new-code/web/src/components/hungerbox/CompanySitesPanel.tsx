/**
 * CompanySitesPanel — the per-site prequalified-questions panel shown on
 * CompanyDetailPage. Lists all sites for the company; each site shows:
 *   - City, employee count, commercial model, notes
 *   - DNC + feasibility status + action buttons
 *   - Edit-in-place for prequalified answers
...
export function CompanySitesPanel({ companyId, actorId }: CompanySitesPanelProps) {
  ...
  return (
    <div>
      {/* Company-level DNC / feasibility actions */}
